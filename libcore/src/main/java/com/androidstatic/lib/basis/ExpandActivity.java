...
public abstract class ExpandActivity extends Activity {
     ...
     * @return 异步任务实例
     */
    protected final ActivityTask execute(ThreadExecutor threadExecutor, int what, Object... params) {
     ...
     * 运行生命周期相关的异步任务
     *
     * @param activityTask 异步任务实例
     * @param params       异步任务运行参数
     * @return 异步任务实例
     */
    protected final ActivityTask execute(ActivityTask activityTask, Object... params) {
     ...
     * @return 异步任务实例
     */
    protected final ActivityTask execute(ThreadExecutor threadExecutor, ActivityTask activityTask, Object... params) {
    ...
    public static class ActivityTask extends AsyncTask<Object, Object, Object> {
         ...
         * 构造方法
         *
         * @param activity 生命周期相关的Activity
         * @param what     异步任务标志
         */
